...
<link rel="stylesheet" href="/IE104_PROJECT/css/style-donate.css">
</head>
...
<main>
    ...
    <div class="donate-thanks">
      <!-- <div class="thanks-img">
          <img src="https://i.pinimg.com/474x/a8/e3/9b/a8e39b287c7cd7af410dc230c36c226f.jpg"  class="img-donate" alt="Member" width: 100%/>
        </div> -->
      <div class="thanks-text">
        <h1>Thank you</h1>
        <p>Sincere thanks to the listeners who took the time to listen to our podcast. Oddly normal is a non-profit
          project with the desire to share knowledge with the community and thereby also learn more from you.</p>
        <p>Currently the project is carried out entirely with personal resources. On average, to produce 1 hour of
          ...
          addition, to keep the podcast running, we also have to pay certain types of costs.</p>
        <p>In order to produce more quality content, we would love to receive support from Oddly normal's audience for
          ideas, advice and especially finance. 🙂</p>
      </div>
    </div>
    <section class="donate-purpose">
      <h1>How it works</h1>
      <div class="container">
          ...
          <div class="col-md">
            <div class="card bg-secondary text-light">
              <div class="card-body text-center">
                ...
                <p class="card-text">
                  Pay the cost of hosting, domain name, website…
                </p>
              </div>
            </div>
          </div>
          <div class="col-md">
            <div class="card bg-dark text-light">
              <div class="card-body text-center">
                ...
                <p class="card-text">
                  Pay the cost of purchasing software copyrights, music, books, materials for podcast production
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="donate-method">
      <div>
        <p class="method-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-bank2"
            viewBox="0 0 16 16">
            <path
              d="M8.277.084a.5.5 0 0 0-.554 0l-7.5 5A.5.5 0 0 0 .5 6h1.875v7H1.5a.5.5 0 0 0 0 1h13a.5.5 0 1 0 0-1h-.875V6H15.5a.5.5 0 0 0 .277-.916l-7.5-5zM12.375 6v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zm-2.5 0v7h-1.25V6h1.25zM8 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2zM.5 15a.5.5 0 0 0 0 1h15a.5.5 0 1 0 0-1H.5z" />
          </svg>
        </p>
        <p class="method-text"> BIDV 12345567 </p>
      </div>
      <div>
        <p class="method-icon">
        ...
        <p class="method-text"> SĐT 125634222 </p>
      </div>
      <div>
        <p class="method-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-phone-vibrate"
            viewBox="0 0 16 16">
            <path
        ...
        <p class="method-text"> SĐT 123456777 </p>
      </div>
    </div>
  </main>
